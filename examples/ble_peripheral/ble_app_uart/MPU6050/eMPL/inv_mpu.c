...
//}
#define log_i 	MY_LOG_INFO	//��ӡ��Ϣ
#define log_e  	MY_LOG_ERROR//��ӡ��Ϣ
...
/**
* @brief : void mpu_int_pin_init(uint32_t pin,nrfx_gpiote_evt_handler_t callback)
* @param : pin [in] ���������жϵ����ţ�callback [cb] �ص���������nrf���е�gpiote����ģ��һ��
* @attention : �жϼ������ӣ�����ֱ��ʹ�øú�����Ϊ��Ӧ���ж�ʱ��Ӧ���жϺ���
* @author : Sheep
* @date : 23/11/14
*/
void mpu_int_pin_init(uint32_t pin,nrfx_gpiote_evt_handler_t callback)
{
    ret_code_t err_code;
    ...
    nrf_drv_gpiote_in_config_t inConfig = GPIOTE_CONFIG_IN_SENSE_TOGGLE(false); // Ĭ�ϳ�ʼ����˫���ء������жϴ�����false��ʾ��high accuracy
    inConfig.pull = NRF_GPIO_PIN_PULLUP;      //��������						
    inConfig.sense = NRF_GPIOTE_POLARITY_HITOLO;// �½���
